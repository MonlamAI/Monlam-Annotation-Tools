"""
Django settings for Monlam Doccano project.
Production-grade annotation tracking with Tibetan language support.
"""
...
# ALLOWED_HOSTS - supports wildcards like .onrender.com
...
CORS_ALLOWED_ORIGINS = config(
    ...
    default='http://localhost:3000,http://127.0.0.1:3000,https://annotate.monlam.ai,https://monlam-doccano.onrender.com',
    cast=Csv()
)
CORS_ALLOW_CREDENTIALS = True

# CSRF Trusted Origins (required for custom domains)
CSRF_TRUSTED_ORIGINS = [
    'https://annotate.monlam.ai',
    'https://monlam-doccano.onrender.com',
    'https://*.onrender.com',
    'https://*.monlam.ai',
]
...
MONLAM_SETTINGS = {
    ...
    'BRANDING': {
        'PRIMARY_COLOR': '#B8963E',  # Monlam Gold
        'PRIMARY_COLOR_DARK': '#9A7B32',
        'NAVBAR_COLOR': '#1a1a2e',  # Monlam Navy
    },
}
