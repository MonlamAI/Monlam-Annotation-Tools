"""
Monlam-patched project permissions.
Adds project_manager role to IsProjectMember.
"""
...
# MONLAM: Add Project Manager role permission
class IsProjectManagerAndReadOnly(RolePermission):
...
# MONLAM: Include project_manager in IsProjectMember
IsProjectMember = IsAnnotator | IsAnnotationApprover | IsProjectAdmin | IsProjectManager  # type: ignore
IsProjectStaffAndReadOnly = IsAnnotatorAndReadOnly | IsAnnotationApproverAndReadOnly | IsProjectManagerAndReadOnly  # type: ignore
