...
export class ExampleDTO {
  ...
  url: string
  isConfirmed: boolean
  annotatedByUsername: string | null
  ...
  constructor(item: ExampleItem) {
    ...
    this.annotatedByUsername = item.annotatedByUsername
    this.reviewedByUsername = item.reviewedByUsername
    this.trackingStatus = item.trackingStatus
  }
}
